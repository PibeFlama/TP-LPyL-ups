...
const materiasSchema = Joi.object().keys({
    ...
    cuatrimestral: Joi.boolean().required().messages({
        ...
        "any.only": "solo se permiten los valores true o false para el campo cuatrimestral"
    }),
    ...
    carreraId: Joi.number().required().greater(0).messages({
        ...
        "number.base": "debe ingresar un número en carreraId",
        "number.greater": "debe ser ingresar un número mayor a cero en carreraId"
    })
})
